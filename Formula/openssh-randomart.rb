class OpensshRandomart < Formula
  ...
  depends_on "ssh-randomartd" => :recommended

  # We replace the original "openssh" from core repository
  conflicts_with "openssh", because: "this is an alternative OpenSSH"
  ...
  # Extra patch with OPENSSH_RANDOMART_SOCKET support
  patch do
    url "https://git.sr.ht/~ilammy/openssh-portable/commit/3b0d813071edd062ab6b3fef013181b12e770542.patch"
    sha256 "fd85bb41a31291dd94ebf7ae574c8724460277b8ae8c07f235809737ed8ebb49"
  end
